...
<body>
	...
	<div class="container">
		<h2 class="text-center">修改管理员</h2>
		<form id="myForm" action="jsp/admin/AdminManageServlet?action=update" method="post" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<span class="Validform_checktip">密码长度为 4-8 位</span>
				</div>
			</div>
			<div class="form-group">
				<label for="c_passWord" class="col-sm-2 col-sm-offset-2 control-label">确认密码：</label>
				<div class="col-sm-4">
					<input type="password" name="c_passWord" id="c_passWord" class="form-control" value="${adminInfo.passWord}">
				</div>
				<div class="col-sm-4">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<span class="Validform_checktip">姓名长度为 2-8 位</span>
				</div>
			</div>
			<div class="form-group">
