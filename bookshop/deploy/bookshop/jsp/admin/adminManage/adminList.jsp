...
<body>
	...
	<h2 class="text-center">管理员列表</h2>
	<div class="container content">
		<div class="funbtn">
			<a id="batDel" class="btn btn-danger" href="javascript:void(0)">批量删除</a>
			<a class="btn btn-info" href="jsp/admin/adminManage/adminAdd.jsp">新增管理员</a>
		</div>
		<table class="table table-striped table-hover">
			...
			<c:choose>
				...
				<c:otherwise>
					<tr>
						<td colspan="8"><h4 class="text-center">当前没有更多管理员信息</h4></td>
					</tr>
				</c:otherwise>
			</c:choose>
		</table>
...
<script type="text/javascript">
	...
	$("#batDel").click(function(){
		...
		if(confirm("确定要删除 "+choices.length+" 条管理员记录吗？")){
