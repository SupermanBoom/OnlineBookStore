...
<div class="container">
    ...
    <div class="row">
    	...
    	<div class="col-sm-4 ">
    		...
    		<span id="imgSpan">点击图片更换图书图片</span>
    		<form id="imgForm" action="jsp/admin/BookManageServlet?action=updateImg&id=${bookInfo.bookId}" method="post" enctype="multipart/form-data">
    			...
    			<input type="submit" id="sub" value="保存图片" class="btn btn-info" style="display:none;margin-left:5px;">
    		</form>
    	</div>
    </div>
     <div class="row">
    ...
    <form id="bookAddForm" class="form-horizontal" action="jsp/admin/BookManageServlet?action=update" method="post">
        ...
        <div class="form-group">
            <label for="catalog" class="col-sm-2 col-sm-offset-2 control-label">图书分类</label>
            <div class="col-sm-4">
        ...
        <div class="form-group">
			<label for="stock" class="col-sm-2 col-sm-offset-2 control-label">库存数量</label>
			<div class="col-sm-4 ">
				<input type="number" min="0" name="stock" id="stock" class="form-control" value="${bookInfo.stock}"/>
			</div>
			<div class="col-sm-4 Validform_checktip"></div>
		</div>
        <div class="form-group">
			<label for="author" class="col-sm-2 col-sm-offset-2 control-label">作者</label>
			<div class="col-sm-4 ">
		...
		<div class="form-group">
			<label for="press" class="col-sm-2 col-sm-offset-2 control-label">出版社</label>
			<div class="col-sm-4 ">
    	...
    	<div class="form-group">
            <label for="desc" class="col-sm-2 col-sm-offset-2 control-label">图书简介</label>
            <div class="col-sm-4">
