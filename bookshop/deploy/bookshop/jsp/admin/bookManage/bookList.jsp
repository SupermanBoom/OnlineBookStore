			...
			<div class="search col-md-4">
				<div class="input-group">
					<form action="jsp/admin/BookManageServlet" method="get">
						...
						<input style="float: left;width: 160px;" type="text" class="form-control" name="bookname" placeholder="请输入想搜索的图书名称...">
						&nbsp;&nbsp;&nbsp;
		...
		<table class="table table-striped table-hover">
			<tr class="success">
				<th>
					...
					<label for="batDelChoice">全选/反选</label>
				</th>
				<th>图书名称</th>
				<th>图书分类</th>
				<th>作者</th>
			...
			<c:choose>
				<c:when test="${!empty bookList}">
					<c:forEach items="${bookList}" var="i">
						<tr>
							<td class="noClick"><input type="checkbox" name="choice" value="${i.bookId}"></td>
							<td>${i.bookName}</td>
				...
				<c:otherwise>
					<tr>
						<td colspan="8"><h4 class="text-center">当前没有更多图书信息</h4></td>
					</tr>
				</c:otherwise>
			</c:choose>
		</table>
...
<script type="text/javascript">
	...
	$(".homePage").click(function(){
		window.location="${basePath}jsp/admin/BookManageServlet?action=list&page=1";
	})
	...
	$("#batDel").click(function(){
		...
		if(confirm("确定要删除这 "+choices.length+" 条图书记录吗？")){
