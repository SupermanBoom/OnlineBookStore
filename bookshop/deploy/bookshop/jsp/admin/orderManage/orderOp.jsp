	...
	<div class="container content">
		<table class="table table-striped table-hover">
			...
			<c:choose>
					...
					<c:forEach items="${orderList}" var="i">
						<tr>
							...
							<td>
								...
								<a class="btn btn-info btn-sm" href="jsp/admin/OrderManageServlet?action=ship&id=${i.orderId}" onclick="return confirm('确定要发货了吗？')">发货</a>
							</td>
						</tr>
					</c:forEach>
				</c:when>
				<c:otherwise>
					<tr>
						<td colspan="7"><h4 class="text-center">当前没有更多订单信息</h4></td>
					</tr>
				</c:otherwise>
			</c:choose>
		</table>
