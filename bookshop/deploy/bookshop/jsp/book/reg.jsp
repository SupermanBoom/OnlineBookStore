			...
			<div class="main container">
				<div class="title">
					<ul class="nav nav-tabs" id="myTab">
						<li role="presentation" class="active"><a href="#tab_login" data-toggle="tab">登录</a></li>
					  	<li role="presentation"><a href="#tab_reg" data-toggle="tab">新用户注册</a></li>
					...
					<div id="tab_reg" class="tab-pane fade">
						<form id="regForm" action="UserServlet?action=reg" method="post" class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-md-4">
									<span class="Validform_checktip">*用户名为 2~15 位字符</span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-4">
									<span class="Validform_checktip">*密码为 2~8 位字符</span>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<span class="Validform_checktip">*姓名为 2~8 位字符</span>
								</div>
							</div>
							<div class="form-group">
