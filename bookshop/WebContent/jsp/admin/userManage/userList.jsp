...
<body>
	...
	<div class="container content">
		<div class="funbtn">
			...
			<a class="btn btn-info" href="jsp/admin/userManage/userAdd.jsp">新增用户</a>
			...
			<c:choose>
				<c:when test="${!empty userList}">
					<c:forEach items="${userList}" var="i">
						<tr>
							<td><input type="checkbox" name="choice" value="${i.userId}"></td>
							<td>${i.userId}</td>
							<td>${i.userName}</td>
				...
				<c:otherwise>
					<tr>
						<td colspan="8"><h4 class="text-center">当前没有更多用户信息</h4></td>
					</tr>
				</c:otherwise>
			</c:choose>
		</table>
...
<script type="text/javascript">
	...
	$("#batDel").click(function(){
		...
		if(confirm("确定要删除 "+choices.length+" 条用户记录吗？")){
